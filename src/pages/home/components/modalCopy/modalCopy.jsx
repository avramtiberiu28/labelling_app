...
export default function ModalCopy({ show, onClose, id_eticheta, id_categorie, onLabelAdded}) {
    ...
    useEffect(() => {
        // Verificăm dacă obiectul label diferă de starea anterioară a sa
        const isModified = !isEqual(label, prevLabel);
        if (isModified) {
            fetchImage();
            //console.log('Obiectul label a fost modificat:', label);
            setPrevLabel(label);
        }
    ...
    return (
        <Modal show={showModal} onHide={handleCloseModal} animation={true} style={{ opacity: 1 }} id='modal_copy' contentClassName='flex flex-row'>
            ...
            <div className='relative flex flex-col w-full left-[-2.15rem] pt-5'>
                <div className='flex flex-row w-full justify-center items-center'>
                    <p className='text-4xl font-bold'>Formular copiere eticheta</p>
                </div>
                    ...
                    <div className='flex w-full px-10 py-10'>
                        <Form className='w-full'>
                            ...
                            {locatii_corner.includes(idLocatie) ?
                                ...
                                <Form.Group className='pt-5' controlId='dataExpirarii'>
                                    <Form.Label className='mb-0' onBlur={handleBlur}>Termen de valabilitate(zile): </Form.Label>
                                    <Form.Control readOnly={readOnly} defaultValue={label.dataExpirarii} className={invalid.dataExpirarii} placeholder='Ex. 30, 60, 365' type='input'></Form.Control>
                                    <Form.Control.Feedback type="invalid" className={'validation '+invalid.dataExpirarii}>
                            ...
                            {isTransat &&
                                <Form.Group className='pt-5' controlId='transat'>
                                    <Form.Label className='mb-0'>Transat: </Form.Label>
