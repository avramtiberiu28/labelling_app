...
export default function ModalAdd({ show, onClose, onLabelAdded }) {
    ...
    const handleSaveLabel = async () => {
        ...
        try {
            ...
            Swal.fire({
                icon: "success",
                title: "Eticheta salvata cu succes!",
        ...
        <Modal show={showModal} onHide={handleCloseModal} animation={true} style={{ opacity: 1 }} id='modal_add' contentClassName='flex flex-row'>
            ...
            <div className='relative flex flex-col w-full left-[-2.15rem] pt-5'>
                <div className='flex flex-row w-full justify-center items-center'>
                    <p className='text-4xl font-bold'>Formular adaugare eticheta</p>
                </div>
                    ...
                    <div className='flex w-full px-10 my-10 border-r-[2px]'>
                        <Form className='w-full'>
                            <Form.Group controlId='denumire'>
                                ...
                                <Form.Control type='input' className={invalid.denumire} name="denumire" onBlur={handleBlur}></Form.Control>
                            ...
                            <Form.Group className='pt-5' controlId='id_categorie'>
                                ...
                                <Form.Select className={invalid.id_categorie} onChange={handleChange}>
                            ...
                            <Form.Group className='pt-5' controlId='informatiiAditionale'>
                                ...
                                <Form.Control readOnly={readOnly} defaultValue={produs} onBlur={handleBlur} type='input'></Form.Control>
                            </Form.Group>
                            <Form.Group className='pt-5' controlId='ingrediente'>
                                <Form.Label className='mb-0'>Ingrediente: </Form.Label>
                                <Form.Control as='textarea' className={invalid.ingrediente} style={{height: '8rem'}} onBlur={handleBlur}></Form.Control>
                            ...
                            <Form.Group className='pt-5' controlId='valoriEnergetice'>
                                ...
                                <Form.Control as='textarea' className={invalid.valoriEnergetice} style={{height: '8rem'}} onBlur={handleBlur}></Form.Control>
                            ...
                            <Form.Group className='pt-5' controlId='alergeni'>
                                ...
                                <Form.Control placeholder='Ex. mustar, lactoza, etc.' type='input' onBlur={handleBlur}></Form.Control>
                            </Form.Group>
                            <Form.Group className='pt-5' controlId='contineUrme'>
                                <Form.Label className='mb-0'>Contine urme: </Form.Label>
                                <Form.Control placeholder='Ex. mustar, etc.' type='input' onBlur={handleBlur}></Form.Control>
                            </Form.Group>
                            <Form.Group className='pt-5' controlId='precizari'>
                                <Form.Label className='mb-0'>Precizari: </Form.Label>
                                <Form.Control placeholder='Ex. +/- 5% grame.' type='input' onBlur={handleBlur}></Form.Control>
                            </Form.Group>
                        </Form>
                    </div>
                        ...
                        <Form className='w-full'>
                            ...
                            {locatii_corner.includes(idLocatie) ?
                                ...
                                <Form.Group className='pt-5' controlId='dataExpirarii'>
                                    ...
                                    <Form.Control readOnly={readOnly} onBlur={handleBlur} className={invalid.dataExpirarii} placeholder='Ex. 30, 60, 365' type='number'></Form.Control>
                                    <Form.Control.Feedback type="invalid" className={'validation '+invalid.dataExpirarii}>
                            ...
                            {isTransat &&
                                <Form.Group className='pt-5' controlId='transat'>
                                    ...
                                    <input name='transat' type='checkbox' checked={checked}  onChange={handleCheck}/>
                                </Form.Group>
                            }
